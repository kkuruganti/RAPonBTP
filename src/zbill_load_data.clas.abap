CLASS zbill_load_data DEFINITION
  PUBLIC
  FINAL
  CREATE PUBLIC .
  PUBLIC SECTION.
...
CLASS zbill_load_data IMPLEMENTATION.
  METHOD if_oo_adt_classrun~main.

*data: lt_bill_header TYPE STANDARD TABLE OF zbilling_header.
*
...
*    ).
*
*    INSERT zbilling_header FROM TABLE @lt_bill_header.
*    out->write( 'Billing data is inserted' ).

DATA lt_bill_item TYPE STANDARD TABLE OF zbilling_item.

DELETE FROM zbilling_item.
...
INSERT zbilling_item FROM TABLE @lt_bill_item.
